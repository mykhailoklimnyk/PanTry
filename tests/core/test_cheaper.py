...
from komora.core.substitution import covers
...
def test_a_cheaper_hint_may_not_change_the_sort():
    mine = "Нектар Jaffa ананасовий"
    assert covers("Нектар Jaffa ананасовий 2 л", mine) is True
    assert covers("Нектар Jaffa ананасовий", mine) is True
    assert covers("Нектар Jaffa вишневий", mine) is False
    assert covers("Нектар «Світанок» яблучний", mine) is False


def test_without_a_chosen_name_the_floor_says_no():
    assert covers("Нектар Jaffa ананасовий", "") is False
    assert covers("", "Нектар Jaffa ананасовий") is False
