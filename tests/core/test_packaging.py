...
def test_a_pack_of_pieces_or_kilograms_is_a_pack_too():
    assert receipt_unit("100шт") == "уп"
    assert receipt_unit("10 шт") == "уп"
    assert receipt_unit("2кг") == "уп"
    assert receipt_unit("0,5 кг") == "уп"


def test_a_single_piece_is_still_a_piece():
    assert receipt_unit("1шт") == "шт"
    assert receipt_unit("1 шт") == "шт"
