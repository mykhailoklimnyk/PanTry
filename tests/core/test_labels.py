...
"""СКЕЛЕТ МІТКИ ВИДУ: луна, яка розійшлась роздільником (#366).

Живий прогін 08.09 на прод-базі: питаємо «йогурт · фруктовий», модель
відповідає «йогурт фруктовий», рядок гине -- 49 з 91 на холодному прогоні,
тобто 54% найдорожчої відповіді. Під міткою лежить ВІЧНИЙ кеш глузду і стелі
зберігання, тож утрачений рядок означає вид без вироку і без ярусу назавжди.

І дрейф НЕ ДЕТЕРМІНОВАНИЙ -- два прогони того самого входу на температурі 0
дали 41 розходження і нуль. Саме тому лікує його зіставлення, а не речення в
промпті: правило, яке спрацьовує через раз, від відсутнього не відрізнити.
"""
