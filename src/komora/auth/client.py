...
class AuthError(RuntimeError):
    """Сервер відмовив, не відповів або відповів не тим. Людською мовою.

    «Не відповів» тут не окремий випадок: гість однаково не зайшов, і робити
    йому однаково що — спробувати ще раз. Тому мертвий MCP приходить сюди, а
    не сирим `httpx` (#167).
    """
